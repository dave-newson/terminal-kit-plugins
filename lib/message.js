...
const styles = {
    ...
    success:    { padding: 1,  full_width: true, prefix: '[OK]',        style: ['black', 'bgBrightGreen'], },
    error:      { padding: 1,  full_width: true, prefix: '[ERROR]',     style: ['brightWhite', 'bgBrightRed', 'blink'], },
    warning:    { padding: 1,  full_width: true, prefix: '[WARNING]',   style: ['brightWhite', 'bgRed'], },
    notice:     { padding: 1,  full_width: true, prefix: '[NOTICE]',    style: ['black', 'bgBrightYellow'], },
    data:       { padding: -1, full_width: true, prefix: false,         style: ['defaultColor', 'bgDefaultColor'], },
};
    ...
    _format(message, options) {
        ...
        if (options.padding >= 0) {
            ...
            message = message.split('\n').map((line) => {
                return line.padEnd(this._terminal.width, ' ');
            }).join('\n');
